...
themeStyle,
parentStyle['*'],
parentStyle[componentName]].concat(babelHelpers.toConsumableArray(
_lodash2.default.map(styleNames,function(sn){return themeStyle['.'+sn];})),babelHelpers.toConsumableArray(
_lodash2.default.map(styleNames,function(sn){return parentStyle['*.'+sn];})),babelHelpers.toConsumableArray(
...
parentStyle['*'],
parentStyle[componentName]].concat(babelHelpers.toConsumableArray(
_lodash2.default.map(styleNames,function(sn){return mergedStyle['.'+sn];})),babelHelpers.toConsumableArray(
_lodash2.default.map(styleNames,function(sn){return parentStyle['*.'+sn];})),babelHelpers.toConsumableArray(
_lodash2.default.map(styleNames,function(sn){return parentStyle[componentName+'.'+sn];})),[
