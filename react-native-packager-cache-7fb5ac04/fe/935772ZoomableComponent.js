...
makeZoomable;var _react=require('react');var _react2=babelHelpers.interopRequireDefault(_react);var _reactNative=require('react-native');function getDistanceBetweenTwoPoints(_ref,_ref2){var x1=_ref.x,y1=_ref.y;var x2=_ref2.x,y2=_ref2.y;var dx=Math.abs(x1-x2);var dy=Math.abs(y1-y2);return Math.sqrt(Math.pow(dx,2)+Math.pow(dy,2));}function middle1D(p1,p2){return p1>p2?p1-(p1-p2)/2:p2-(p2-p1)/2;}function middle2D(_ref3,_ref4){var x1=_ref3.x,y1=_ref3.y;var x2=_ref4.x,y2=_ref4.y;return{x:middle1D(x1,x2),y:middle1D(y1,y2)};}function maxOffset(offset,windowDimension,imageDimension){var max=windowDimension-imageDimension;if(max>=0){return 0;}return offset<max?max:offset;}function getOffsetByZoom(_ref5,_ref6){var width=_ref5.width,height=_ref5.height,zoom=_ref5.zoom;var componentWidth=_ref6.componentWidth,componentHeight=_ref6.componentHeight;var xDiff=componentWidth*zoom-width;var yDiff=componentHeight*zoom-height;return{left:-xDiff/2,top:-yDiff/2};}function makeZoomable(ComponentToBeDecorated){var
...
ZoomDecorator=function(_Component){babelHelpers.inherits(ZoomDecorator,_Component);
...
function ZoomDecorator(props){babelHelpers.classCallCheck(this,ZoomDecorator);var _this=babelHelpers.possibleConstructorReturn(this,(ZoomDecorator.__proto__||Object.getPrototypeOf(ZoomDecorator)).call(this,
props));
...
}babelHelpers.createClass(ZoomDecorator,[{key:'componentWillMount',value:function componentWillMount()

{var _this2=this;
this._panResponder=_reactNative.PanResponder.create({
onStartShouldSetPanResponder:function onStartShouldSetPanResponder(){return true;},
onStartShouldSetPanResponderCapture:function onStartShouldSetPanResponderCapture(){return true;},
onMoveShouldSetPanResponder:function onMoveShouldSetPanResponder(){return true;},
...
onShouldBlockNativeResponder:function onShouldBlockNativeResponder(){return true;}});

}},{key:'isMoveSmall',value:function isMoveSmall(

gesture){
return Math.abs(gesture.dx)<2&&Math.abs(gesture.dy)<2;
}},{key:'processPinch',value:function processPinch(
...
var zoom=touchZoom*this.state.initialZoom>this.state.minZoom?
...
}},{key:'processTouch',value:function processTouch(
...
var offsetTop=layout.height>this.props.componentHeight*zoom?
...
{var _props=
this.props,style=_props.style,otherProps=babelHelpers.objectWithoutProperties(_props,['style']);
return(
...
}}]);return ZoomDecorator;}(_react.Component);ZoomDecorator.propTypes={componentWidth:_react.PropTypes.number.isRequired,componentHeight:_react.PropTypes.number.isRequired,style:_react.PropTypes.object,onPress:_react.PropTypes.func,onZoom:_react.PropTypes.func};
