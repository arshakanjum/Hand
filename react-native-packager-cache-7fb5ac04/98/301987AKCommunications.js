'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.web=exports.textWithoutEncoding=exports.text=exports.email=exports.phonecall=undefined;
...
var text=exports.text=function text(){var phoneNumber=arguments.length>0&&arguments[0]!==undefined?arguments[0]:null;var body=arguments.length>1&&arguments[1]!==undefined?arguments[1]:null;
if(arguments.length>2){
...
var textWithoutEncoding=exports.textWithoutEncoding=function textWithoutEncoding(){var phoneNumber=arguments.length>0&&arguments[0]!==undefined?arguments[0]:null;var body=arguments.length>1&&arguments[1]!==undefined?arguments[1]:null;
if(arguments.length>2){
console.log('you supplied too many arguments. You can either supply 0 or 1 or 2');
return;
}
...
var web=exports.web=function web(){var address=arguments.length>0&&arguments[0]!==undefined?arguments[0]:null;
if(!address){
...
}).catch(function(err){return console.warn('An unexpected error happened',err);});
};
...
{phonecall:phonecall,text:text,textWithoutEncoding:textWithoutEncoding,email:email,web:web};