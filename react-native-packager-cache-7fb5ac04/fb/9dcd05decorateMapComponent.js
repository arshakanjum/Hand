...
decorateMapComponent;var _react=require('react');var _reactNative=require('react-native');var _ProviderConstants=require('./ProviderConstants');var SUPPORTED=exports.SUPPORTED='SUPPORTED';var USES_DEFAULT_IMPLEMENTATION=exports.USES_DEFAULT_IMPLEMENTATION='USES_DEFAULT_IMPLEMENTATION';var NOT_SUPPORTED=exports.NOT_SUPPORTED='NOT_SUPPORTED';function getAirMapName(provider){if(_reactNative.Platform.OS==='android')return'AIRMap';if(provider===_ProviderConstants.PROVIDER_GOOGLE)return'AIRGoogleMap';return'AIRMap';}function getAirComponentName(provider,component){return''+getAirMapName(provider)+component;}var contextTypes=exports.contextTypes={provider:_react.PropTypes.string};var createNotSupportedComponent=exports.createNotSupportedComponent=function createNotSupportedComponent(message){return function(){console.error(message);return null;};};var googleMapIsInstalled=exports.googleMapIsInstalled=!!_reactNative.NativeModules.UIManager[getAirMapName(_ProviderConstants.PROVIDER_GOOGLE)];function decorateMapComponent(Component,_ref){var componentType=_ref.componentType,providers=_ref.providers;
var components={};
